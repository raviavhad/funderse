...
import com.funderse.api.domain.Transaction;
import com.funderse.api.repository.TransactionRepository;
    ...
    public Optional<Transaction> partialUpdate(Transaction transaction) {
        ...
        return transactionRepository
            ...
            .map(existingTransaction -> {
                ...
                if (transaction.getSortOrder() != null) {
                    existingTransaction.setSortOrder(transaction.getSortOrder());
                }
                if (transaction.getPostingDate() != null) {
                    existingTransaction.setPostingDate(transaction.getPostingDate());
                }
                ...
                if (transaction.getDateModified() != null) {
                    existingTransaction.setDateModified(transaction.getDateModified());
                }
