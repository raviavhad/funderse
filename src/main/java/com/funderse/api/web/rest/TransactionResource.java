...
import com.funderse.api.service.TransactionService;
...
/**
 * REST controller for managing {@link com.funderse.api.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
public class TransactionResource {
    ...
    public ResponseEntity<List<Transaction>> getAllTransactions(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
